...
public class NoticiasnuevoPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Noticiasnuevo";
	...
	private NoticiasnuevoPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new NoticiasnuevoPersistentManager();
		}
